...
from pulser.waveforms import RampWaveform, BlackmanWaveform, ConstantWaveform, InterpolatedWaveform
...
def pulser_MIS(antennas_coordinates, distance, active_qubits=None):
    ...
    # Place the qubits correponding to the remaining uncolored edges
